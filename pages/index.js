...
export default function Home() {
  useEffect(() => {
    let scroll = null
    import('locomotive-scroll').then(function (locomotiveModule) {
      ...
      scroll = new locomotiveModule.default(options)
              ...
              <div className="o-layout">
                ...
                >
                  <div className="u-text-right">
                    <p className="u-label c-header_heading_label">v4 – Edition</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="o-layout -gutter">
              <div className="o-layout_item u-2/5@from-medium">
                <p className="c-summary_text">
                  A simple scroll library used by developers at Locomotive. Built as a layer on top of{' '}
                  <em>ayamflow's</em>{' '}
                  <a href="https://github.com/ayamflow/virtual-scroll" target="_blank">
                    virtual-scroll
                  </a>
                  , it provides smooth scrolling with support for parallax effects, toggling classes, and
            ...
            <div className="o-layout_item u-3/5@from-medium">
              ...
              <div className="c-lerp-block">
                ...
                <span className="c-lerp-block_title" data-scroll>
                  ...
                  <span data-scroll data-scroll-delay="0.11" data-scroll-speed="6">
                    {' '}
                  </span>
                  <span data-scroll data-scroll-delay="0.1" data-scroll-speed="6">
                    L
                  </span>
                  <span data-scroll data-scroll-delay="0.09" data-scroll-speed="6">
                    e
                  </span>
            ...
            <div className="o-layout_item u-2/5@from-medium">
              ...
              >
                <div className="c-section_infos_inner" data-scroll data-scroll-offset="200">
                  ...
                  <div className="c-sections_infos_text u-text">
                    <p>Create slides that stick and untick to the viewport while scrolling through.</p>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div className="o-layout_item u-3/5@from-medium">
                  <div className="c-cta_section">
                    <div className="c-cta_content_text" data-scroll data-scroll-offset="100">
                      ...
                      <p>
                        This library has evolved considerably over the years. The architecture and conventions
                        shift according to our projects.
                      </p>
                      <p>
                        Visit the GitHub repository page for a complete introduction and list of available
                        options. Search the GitHub issue tracker carefully to check if your issue/feature has
                        already been reported/requested before opening a new issue or submitting a pull
                        request.
                      </p>
                    </div>
                    <a
                  ...
                  <div className="c-cta_section">
                    <div className="c-cta_content_text" data-scroll data-scroll-offset="100">
                      ...
                      <p>
                        You like the font used on this page? Well this is your lucky day. You can get it on{' '}
                        <a className="o-link -underline" href="https://pangrampangram.com/" target="_blank">
                          pangrampangram.com
                        </a>
